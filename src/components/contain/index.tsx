...
const Contain = memo((props: ContainProps) => {
  const { children, imageURL, hidden, IsHiddenDialogImage = false, isMoreInfo = false } = props;

  const [context] = useContext(Context);
  const { openRanking, openAnnouncement, openMyAward, openDescription, openProcedures } =
